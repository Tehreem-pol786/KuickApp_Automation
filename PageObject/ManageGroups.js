...
class Group
{
    ...
    constructor(page)
    {
        ...
        this.slct_user_automation = "//li[@title='Automation 25 User']//input[@type='checkbox']"
        ...
        this.waitforuser = "//td[normalize-space()='automation.user25@mailinator.com']"
        ...
        this.delete = "//li[contains(@title,'Automation 25 User')]//span[contains(@aria-label,'delete')]//*[name()='svg']"
