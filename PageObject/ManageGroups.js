...
class Group
{
    ...
    constructor(page)
    {
        ...
        this.slct_user_automation = "//li[contains(@title,'Automation 15 User')]//input[contains(@type,'checkbox')]"
        ...
        this.waitforuser = "//td[normalize-space()='automation.user15@mailinator.com']"
        ...
        this.delete = "//li[contains(@title,'Automation 15 User')]//span[contains(@aria-label,'delete')]//*[name()='svg']"
