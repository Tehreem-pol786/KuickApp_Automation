...
class Group
{
    ...
    constructor(page)
    {
        ...
        this.slct_user_automation = "//li[contains(@title,'Automation 13 User')]//input[contains(@type,'checkbox')]"
        ...
        this.waitforuser = "//td[normalize-space()='automation.user13@mailinator.com']"
