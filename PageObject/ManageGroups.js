...
class Group
{
    ...
    constructor(page)
    {
        ...
        this.slct_user_automation = "//li[@title='Automation 38 User']//input[@type='checkbox']"
        ...
        this.waitforuser = "//td[normalize-space()='automation.user38@mailinator.com']"
        ...
        this.delete = "//li[contains(@title,'Automation 38 User')]//span[contains(@aria-label,'delete')]//*[name()='svg']"
