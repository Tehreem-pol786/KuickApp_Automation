...
class Group
{
    ...
    constructor(page)
    {
        ...
        this.waitforuser = "//td[normalize-space()='automation.user7@mailinator.com']"
        ...
        this.delete = "//li[contains(@title,'Automation 7 User')]//span[contains(@aria-label,'delete')]//*[name()='svg']"
