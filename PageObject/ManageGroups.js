...
class Group
{
    ...
    constructor(page)
    {
        ...
        this.slct_user_automation = "//li[@title='Automation 29 User']//input[@type='checkbox']"
        ...
        this.waitforuser = "//td[normalize-space()='automation.user29@mailinator.com']"
        ...
        this.delete = "//li[contains(@title,'Automation 29 User')]//span[contains(@aria-label,'delete')]//*[name()='svg']"
